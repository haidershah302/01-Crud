<template>
    <div class="room_head_container">

        <div class="room_head_block">

            <div class="col-span-4 flex-col-middle text-center">
                <Avatar
            ...
            <div class="col-span-6 flex-col-middle">
                <h1>{{ user.room.name }}</h1>

                <p>ID: {{ user.room.id }}</p>
            </div>

            <div class="col-span-2 flex-col-middle book-mark-button">
        ...
        <div class="col-span-2 flex-col-middle">
...
.room_head_container {
    @apply grid grid-cols-12 gap-2 p-2;
}

.room_head_block {
    @apply grid grid-cols-12 col-span-8
    rounded-box p-1 font-bold bg-gradient-to-tl
    from-[--theme-color] shadow-xl shadow-[--theme-shadow-color]
