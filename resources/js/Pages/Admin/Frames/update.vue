...
let src_static_preview = ref(props.frame.src_static);
let src_animated_preview = ref(props.frame.src_animated);

const formData = useForm({
    name: props.frame.name,
    price: props.frame.price,
    bdr_box: props.frame.bdr_box,
    src_static: '',
    src_animated: '',
});
...
const submitForm = () => {
    formData.post(route('admin.frame.update', props.frame.id));
};
</script>
