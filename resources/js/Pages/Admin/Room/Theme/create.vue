<template>
    <div class="-mt-36 mx-24">
        <h1 class="text-2xl font-mono">Create New Theme</h1>
...
let seat_ring_preview = ref('');
let seat_preview = ref('');
