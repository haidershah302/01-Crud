...
#hero {
    @apply w-full h-64 relative font-mono overflow-hidden mb-8 bg-secondary;
    ...
    <div>
        ...
        <div id="hero">
            ...
            <div class="hero-button-container">
                ...
                <Link :href="route('exchange.history')" class="hero-buttons">
        ...
        <div class="px-4">
            ...
            <p v-show="form.errors" class="text-xl font-bold mb-4 text-error">{{ form.errors.diamonds }}</p>

            <button
                @click.prevent="submit"
                :disabled="!form.diamonds > 0"
                class="btn btn-secondary shadow-lg shadow-secondary/60 w-full"
            >
                Exchange
            </button>
